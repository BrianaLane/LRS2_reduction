...
def initial_setup ( DIR_DICT = None, sci_objects = None, redux_dir = None):
    ...
    return vframes, first_run, second_run, ucam, LAMP_DICT, FLT_LAMP, sky_side, only_sframes, skyframes_orig, skytimes, sci_exptime, drk_exptime
...
def basicred(DIR_DICT, sci_objects, redux_dir, basic = False, dividepf = False,
    ...
    vframes, first_run, second_run, ucam, LAMP_DICT, FLT_LAMP, sky_side, only_sframes, skyframes_orig, skytimes, sci_exptime, drk_exptime = initial_setup ( DIR_DICT, config.sci_objects, redux_dir )
