...
redux_dir       = "shela_CL2278A_test2"	 	#name of the folder reduction is run 
...
CLEAN_AFTER_DONE = False 	#If true it will delete intermediate reduction files for the calibration data
...
diffAtmRef		= False 			#[True/False] Differential atmospheric refraction correction applied if True.
